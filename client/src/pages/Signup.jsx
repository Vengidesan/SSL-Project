  ...
  return (
    <div className="min-h-screen bg-[#fdecec] flex items-center justify-center">
      <div className="bg-white/70 backdrop-blur-lg w-[380px] p-8 rounded-2xl border border-white shadow-lg">
        ...
        <h1 className="text-3xl font-bold text-[#e56565] text-center mb-1">Create Account</h1>
        <p className="text-center text-gray-600 mb-6 text-sm">Join the NITC Mess Portal</p>
        ...
        <p className="text-center text-gray-600 text-sm mt-4">
          ...
          <Link to="/login" className="text-[#e56565] font-semibold hover:underline">
            Login
          </Link>
        </p>
      </div>
